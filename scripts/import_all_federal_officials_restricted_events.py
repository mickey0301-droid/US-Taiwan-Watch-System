...
def main() -> None:
    parser = argparse.ArgumentParser(description="Import restricted-source Taiwan events for all federal executive officials.")
    ...
    parser.add_argument("--output", default="data/raw/federal_official_events_summary.json")
    ...
    with session_scope() as session:
        stmt = (
            ...
            .where(Office.level == "federal", Office.branch == "executive")
        )
                ...
                for hit in discovered:
                    payload = {
                        ...
                        "raw_payload": {
                            ...
                            "batch": "federal_official_all_strict",
                        },
                    }
