...
def main() -> None:
    parser = argparse.ArgumentParser(description="Import restricted-source Taiwan events for all federal house members.")
    ...
    parser.add_argument("--output", default="data/raw/federal_house_events_summary.json")
                ...
                for hit in discovered:
                    payload = {
                        ...
                        "raw_payload": {
                            ...
                            "batch": "federal_house_all_strict",
                        },
                    }
